---
layout: post
title: Creating a Deep Learning Heroku Python/Flask App to use on a Static Jekyll Site (Tutorial)
---
...
## Step 6: Deploy your Flask application as a Heroku app
 ...
 - Navigate over to your git repository created in step 1 and create a `requirements.txt` file, which will tell Heroku all of the requirements that your app needs E.g., for my app I needed the following (yours may be a little different):
 ```Flask
gunicorn
keras
numpy
